<?php
/**
 * JumpLink Magento Boilerplate
 */

class JumpLink_BootstrapNavigation_Block_Page_Html_Topmenu extends Mage_Page_Block_Html_Topmenu
{
	/**
    ...
    protected function _getHtml(Varien_Data_Tree_Node $menuTree, $childrenWrapClass)
    {
        ...
        foreach ($children as $child) {
            ...
            if ($child->hasChildren()) {
                $html .= '<ul class="dropdown-menu level' . $childLevel . ' ' . $childrenWrapClass . '">';
	...
	protected function _getMenuItemClasses(Varien_Data_Tree_Node $item)
	{
		...
		if ($item->hasChildren()) {
			...
			if ($item->getLevel() == 0) {
				...
				$classes[] = 'dropdown dropdown-submenu-hover';
			}
		}
